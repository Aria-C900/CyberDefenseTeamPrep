...
cat > /etc/issue << EOF
LEGAL DISCLAIMER: This computer system is the property of Team #YOURNUMBERHERE LLC. By using this system, all users acknowledge notice of, and agree to comply with, the Acceptable User of Information Technology Resources Polity (AUP). 
